...
export class OperationFilter extends jspb.Message {
	...
	addStatuses(
		value: ondewo_nlu_operation_metadata_pb.OperationMetadata.Status,
		index?: number
	): ondewo_nlu_operation_metadata_pb.OperationMetadata.Status;
	clearTypesList(): void;
	...
	addTypes(
		value: ondewo_nlu_operation_metadata_pb.OperationMetadata.OperationType,
		index?: number
	): ondewo_nlu_operation_metadata_pb.OperationMetadata.OperationType;
