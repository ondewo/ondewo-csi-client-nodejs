...
proto.ondewo.csi.S2sStreamResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    synthetizeResponse: (f = msg.getSynthetizeResponse()) && ondewo_t2s_text$to$speech_pb.SynthesizeResponse.toObject(includeInstance, f),
...
proto.ondewo.csi.CondtionValueUnion.prototype.getUniononeofCase = function() {
  return /** @type {proto.ondewo.csi.CondtionValueUnion.UniononeofCase} */(jspb.Message.computeOneofCase(this, proto.ondewo.csi.CondtionValueUnion.oneofGroups_[0]));
};
