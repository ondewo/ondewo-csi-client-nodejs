...
goog.exportSymbol('proto.ondewo.csi.CondtionValueUnion', null, global);
goog.exportSymbol('proto.ondewo.csi.CondtionValueUnion.UniononeofCase', null, global);
 ...
 * @constructor
 */
proto.ondewo.csi.CondtionValueUnion = function (opt_data) {
	jspb.Message.initialize(this, opt_data, 0, -1, null, proto.ondewo.csi.CondtionValueUnion.oneofGroups_);
};
goog.inherits(proto.ondewo.csi.CondtionValueUnion, jspb.Message);
if (goog.DEBUG && !COMPILED) {
	/**
	 * @public
	 * @override
	 */
	proto.ondewo.csi.CondtionValueUnion.displayName = 'proto.ondewo.csi.CondtionValueUnion';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.ondewo.csi.ControlMessageServiceParameters = function (opt_data) {
	jspb.Message.initialize(
		...
		0,
		-1,
		proto.ondewo.csi.ControlMessageServiceParameters.repeatedFields_,
		proto.ondewo.csi.ControlMessageServiceParameters.oneofGroups_
	);
};
		...
		var f,
			obj = {
				pipelinesList: jspb.Message.toObjectList(
					...
					proto.ondewo.csi.S2sPipeline.toObject,
					includeInstance
				)
			};
...
proto.ondewo.csi.ListS2sPipelinesResponse.serializeBinaryToWriter = function (message, writer) {
	...
	if (f.length > 0) {
		writer.writeRepeatedMessage(1, f, proto.ondewo.csi.S2sPipeline.serializeBinaryToWriter);
	}
};
...
proto.ondewo.csi.S2sStreamResponse.prototype.getResponseCase = function () {
	return /** @type {proto.ondewo.csi.S2sStreamResponse.ResponseCase} */ (
		jspb.Message.computeOneofCase(this, proto.ondewo.csi.S2sStreamResponse.oneofGroups_[0])
	);
};
		...
		var f,
			obj = {
				detectIntentResponse:
					(f = msg.getDetectIntentResponse()) &&
					ondewo_nlu_session_pb.DetectIntentResponse.toObject(includeInstance, f),
				synthetizeResponse:
					(f = msg.getSynthetizeResponse()) &&
					ondewo_t2s_text$to$speech_pb.SynthesizeResponse.toObject(includeInstance, f),
	...
	while (reader.nextField()) {
		...
		switch (field) {
			...
			case 2:
				...
				msg.setSynthetizeResponse(value);
				break;
			case 3:
...
proto.ondewo.csi.S2sStreamResponse.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(1, f, ondewo_nlu_session_pb.DetectIntentResponse.serializeBinaryToWriter);
	}
	f = message.getSynthetizeResponse();
	if (f != null) {
		writer.writeMessage(2, f, ondewo_t2s_text$to$speech_pb.SynthesizeResponse.serializeBinaryToWriter);
	}
	f = message.getSipTrigger();
	if (f != null) {
		writer.writeMessage(3, f, proto.ondewo.csi.SipTrigger.serializeBinaryToWriter);
	}
};
...
/**
 * optional ondewo.t2s.SynthesizeResponse synthetize_response = 2;
 * @return {?proto.ondewo.t2s.SynthesizeResponse}
 */
proto.ondewo.csi.S2sStreamResponse.prototype.getSynthetizeResponse = function () {
 ...
 * @return {!proto.ondewo.csi.S2sStreamResponse} returns this
 */
proto.ondewo.csi.S2sStreamResponse.prototype.setSynthetizeResponse = function (value) {
 ...
 * @return {!proto.ondewo.csi.S2sStreamResponse} returns this
 */
proto.ondewo.csi.S2sStreamResponse.prototype.clearSynthetizeResponse = function () {
	return this.setSynthetizeResponse(undefined);
};
 ...
 * @return {boolean}
 */
proto.ondewo.csi.S2sStreamResponse.prototype.hasSynthetizeResponse = function () {
...
proto.ondewo.csi.CheckUpstreamHealthResponse.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(3, f, google_rpc_status_pb.Status.serializeBinaryToWriter);
	}
};
...
proto.ondewo.csi.CheckUpstreamHealthResponse.prototype.getS2tStatus = function () {
	return /** @type{?proto.google.rpc.Status} */ (jspb.Message.getWrapperField(this, google_rpc_status_pb.Status, 1));
};
...
proto.ondewo.csi.CheckUpstreamHealthResponse.prototype.getNluStatus = function () {
	return /** @type{?proto.google.rpc.Status} */ (jspb.Message.getWrapperField(this, google_rpc_status_pb.Status, 2));
};
...
proto.ondewo.csi.CheckUpstreamHealthResponse.prototype.getT2sStatus = function () {
	return /** @type{?proto.google.rpc.Status} */ (jspb.Message.getWrapperField(this, google_rpc_status_pb.Status, 3));
};
 ...
 * @const
 */
proto.ondewo.csi.CondtionValueUnion.oneofGroups_ = [[1, 2, 3]];

/**
 * @enum {number}
 */
proto.ondewo.csi.CondtionValueUnion.UniononeofCase = {
...
/**
 * @return {proto.ondewo.csi.CondtionValueUnion.UniononeofCase}
 */
proto.ondewo.csi.CondtionValueUnion.prototype.getUniononeofCase = function () {
	return /** @type {proto.ondewo.csi.CondtionValueUnion.UniononeofCase} */ (
		jspb.Message.computeOneofCase(this, proto.ondewo.csi.CondtionValueUnion.oneofGroups_[0])
	);
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	 ...
	 * @return {!Object}
	 */
	proto.ondewo.csi.CondtionValueUnion.prototype.toObject = function (opt_includeInstance) {
		return proto.ondewo.csi.CondtionValueUnion.toObject(opt_includeInstance, this);
	};
	 ...
	 *     the JSPB instance for transitional soy proto support:
	 *     http://goto/soy-param-migration
	 * @param {!proto.ondewo.csi.CondtionValueUnion} msg The msg instance to transform.
	 * @return {!Object}
	 * @suppress {unusedLocalVariables} f is only used for nested messages
	 */
	proto.ondewo.csi.CondtionValueUnion.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				intValue: jspb.Message.getFieldWithDefault(msg, 1, 0),
				floatValue: jspb.Message.getFloatingPointFieldWithDefault(msg, 2, 0.0),
				datetimeValue:
					(f = msg.getDatetimeValue()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f)
			};
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.ondewo.csi.CondtionValueUnion}
 */
proto.ondewo.csi.CondtionValueUnion.deserializeBinary = function (bytes) {
	var reader = new jspb.BinaryReader(bytes);
	var msg = new proto.ondewo.csi.CondtionValueUnion();
	return proto.ondewo.csi.CondtionValueUnion.deserializeBinaryFromReader(msg, reader);
};

/**
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.ondewo.csi.CondtionValueUnion} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ondewo.csi.CondtionValueUnion}
 */
proto.ondewo.csi.CondtionValueUnion.deserializeBinaryFromReader = function (msg, reader) {
	while (reader.nextField()) {
		if (reader.isEndGroup()) {
			break;
		}
 ...
 * @return {!Uint8Array}
 */
proto.ondewo.csi.CondtionValueUnion.prototype.serializeBinary = function () {
	var writer = new jspb.BinaryWriter();
	proto.ondewo.csi.CondtionValueUnion.serializeBinaryToWriter(this, writer);
	return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.ondewo.csi.CondtionValueUnion} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ondewo.csi.CondtionValueUnion.serializeBinaryToWriter = function (message, writer) {
	var f = undefined;
 ...
 * @return {number}
 */
proto.ondewo.csi.CondtionValueUnion.prototype.getIntValue = function () {
	return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};

/**
 * @param {number} value
 * @return {!proto.ondewo.csi.CondtionValueUnion} returns this
 */
proto.ondewo.csi.CondtionValueUnion.prototype.setIntValue = function (value) {
	return jspb.Message.setOneofField(this, 1, proto.ondewo.csi.CondtionValueUnion.oneofGroups_[0], value);
};
 ...
 * @return {!proto.ondewo.csi.CondtionValueUnion} returns this
 */
proto.ondewo.csi.CondtionValueUnion.prototype.clearIntValue = function () {
	return jspb.Message.setOneofField(this, 1, proto.ondewo.csi.CondtionValueUnion.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.ondewo.csi.CondtionValueUnion.prototype.hasIntValue = function () {
	return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {number}
 */
proto.ondewo.csi.CondtionValueUnion.prototype.getFloatValue = function () {
 ...
 * @return {!proto.ondewo.csi.CondtionValueUnion} returns this
 */
proto.ondewo.csi.CondtionValueUnion.prototype.setFloatValue = function (value) {
	return jspb.Message.setOneofField(this, 2, proto.ondewo.csi.CondtionValueUnion.oneofGroups_[0], value);
};
 ...
 * @return {!proto.ondewo.csi.CondtionValueUnion} returns this
 */
proto.ondewo.csi.CondtionValueUnion.prototype.clearFloatValue = function () {
	return jspb.Message.setOneofField(this, 2, proto.ondewo.csi.CondtionValueUnion.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.ondewo.csi.CondtionValueUnion.prototype.hasFloatValue = function () {
	return jspb.Message.getField(this, 2) != null;
};

/**
 * optional google.protobuf.Timestamp datetime_value = 3;
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.ondewo.csi.CondtionValueUnion.prototype.getDatetimeValue = function () {
 ...
 * @return {!proto.ondewo.csi.CondtionValueUnion} returns this
 */
proto.ondewo.csi.CondtionValueUnion.prototype.setDatetimeValue = function (value) {
	return jspb.Message.setOneofWrapperField(this, 3, proto.ondewo.csi.CondtionValueUnion.oneofGroups_[0], value);
};
 ...
 * @return {!proto.ondewo.csi.CondtionValueUnion} returns this
 */
proto.ondewo.csi.CondtionValueUnion.prototype.clearDatetimeValue = function () {
 ...
 * @return {boolean}
 */
proto.ondewo.csi.CondtionValueUnion.prototype.hasDatetimeValue = function () {
	return jspb.Message.getField(this, 3) != null;
};
...
proto.ondewo.csi.ControlMessageServiceParameters.prototype.getConfigCase = function () {
	return /** @type {proto.ondewo.csi.ControlMessageServiceParameters.ConfigCase} */ (
		jspb.Message.computeOneofCase(this, proto.ondewo.csi.ControlMessageServiceParameters.oneofGroups_[0])
	);
};
...
proto.ondewo.csi.ControlMessageServiceParameters.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(1, f, ondewo_t2s_text$to$speech_pb.RequestConfig.serializeBinaryToWriter);
	}
	...
	if (f != null) {
		writer.writeMessage(6, f, ondewo_nlu_context_pb.Context.serializeBinaryToWriter);
	}
	f = message.getSessionId();
	if (f.length > 0) {
	...
	if (f != null) {
		writer.writeMessage(9, f, proto.ondewo.csi.Condition.serializeBinaryToWriter);
	}
	f = message.getConditionEnd();
	if (f != null) {
		writer.writeMessage(10, f, proto.ondewo.csi.Condition.serializeBinaryToWriter);
	}
};
...
proto.ondewo.csi.ControlMessageServiceParameters.prototype.setT2sConfig = function (value) {
	return jspb.Message.setOneofWrapperField(
		this,
		1,
		proto.ondewo.csi.ControlMessageServiceParameters.oneofGroups_[0],
		value
	);
};
...
proto.ondewo.csi.ControlMessageServiceParameters.prototype.getContext = function () {
	return /** @type{?proto.ondewo.nlu.Context} */ (jspb.Message.getWrapperField(this, ondewo_nlu_context_pb.Context, 6));
};
...
proto.ondewo.csi.ControlMessageServiceParameters.prototype.getConditionStart = function () {
	return /** @type{?proto.ondewo.csi.Condition} */ (jspb.Message.getWrapperField(this, proto.ondewo.csi.Condition, 9));
};
...
proto.ondewo.csi.ControlMessageServiceParameters.prototype.getConditionEnd = function () {
	return /** @type{?proto.ondewo.csi.Condition} */ (jspb.Message.getWrapperField(this, proto.ondewo.csi.Condition, 10));
};
	...
	proto.ondewo.csi.ControlMessage.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				parameters:
					(f = msg.getParameters()) && proto.ondewo.csi.ControlMessageServiceParameters.toObject(includeInstance, f)
			};
...
proto.ondewo.csi.ControlMessage.serializeBinaryToWriter = function (message, writer) {
	...
	if (f != null) {
		writer.writeMessage(3, f, proto.ondewo.csi.ControlMessageServiceParameters.serializeBinaryToWriter);
	}
};
