...
interface IConversationsService_ICreateS2sPipeline
	extends grpc.MethodDefinition<ondewo_csi_conversation_pb.S2sPipeline, google_protobuf_empty_pb.Empty> {
...
interface IConversationsService_IGetS2sPipeline
	extends grpc.MethodDefinition<ondewo_csi_conversation_pb.S2sPipelineId, ondewo_csi_conversation_pb.S2sPipeline> {
...
interface IConversationsService_IUpdateS2sPipeline
	extends grpc.MethodDefinition<ondewo_csi_conversation_pb.S2sPipeline, google_protobuf_empty_pb.Empty> {
...
interface IConversationsService_IDeleteS2sPipeline
	extends grpc.MethodDefinition<ondewo_csi_conversation_pb.S2sPipelineId, google_protobuf_empty_pb.Empty> {
...
interface IConversationsService_IListS2sPipelines
	extends grpc.MethodDefinition<
		ondewo_csi_conversation_pb.ListS2sPipelinesRequest,
		ondewo_csi_conversation_pb.ListS2sPipelinesResponse
	> {
...
interface IConversationsService_IS2sStream
	extends grpc.MethodDefinition<
		ondewo_csi_conversation_pb.S2sStreamRequest,
		ondewo_csi_conversation_pb.S2sStreamResponse
	> {
...
interface IConversationsService_ICheckUpstreamHealth
	extends grpc.MethodDefinition<
		google_protobuf_empty_pb.Empty,
		ondewo_csi_conversation_pb.CheckUpstreamHealthResponse
	> {
...
interface IConversationsService_IGetControlStream
	extends grpc.MethodDefinition<
		ondewo_csi_conversation_pb.ControlStreamRequest,
		ondewo_csi_conversation_pb.ControlStreamResponse
	> {
...
interface IConversationsService_ISetControlStatus
	extends grpc.MethodDefinition<
		ondewo_csi_conversation_pb.SetControlStatusRequest,
		ondewo_csi_conversation_pb.SetControlStatusResponse
	> {
...
export interface IConversationsServer {
	...
	getS2sPipeline: grpc.handleUnaryCall<
		ondewo_csi_conversation_pb.S2sPipelineId,
		ondewo_csi_conversation_pb.S2sPipeline
	>;
	...
	listS2sPipelines: grpc.handleUnaryCall<
		ondewo_csi_conversation_pb.ListS2sPipelinesRequest,
		ondewo_csi_conversation_pb.ListS2sPipelinesResponse
	>;
	s2sStream: grpc.handleBidiStreamingCall<
		ondewo_csi_conversation_pb.S2sStreamRequest,
		ondewo_csi_conversation_pb.S2sStreamResponse
	>;
	checkUpstreamHealth: grpc.handleUnaryCall<
		google_protobuf_empty_pb.Empty,
		ondewo_csi_conversation_pb.CheckUpstreamHealthResponse
	>;
	getControlStream: grpc.handleServerStreamingCall<
		ondewo_csi_conversation_pb.ControlStreamRequest,
		ondewo_csi_conversation_pb.ControlStreamResponse
	>;
	setControlStatus: grpc.handleUnaryCall<
		ondewo_csi_conversation_pb.SetControlStatusRequest,
		ondewo_csi_conversation_pb.SetControlStatusResponse
	>;
}
...
export interface IConversationsClient {
	...
	getS2sPipeline(
		...
		callback: (error: grpc.ServiceError | null, response: ondewo_csi_conversation_pb.S2sPipeline) => void
	): grpc.ClientUnaryCall;
	getS2sPipeline(
		request: ondewo_csi_conversation_pb.S2sPipelineId,
		metadata: grpc.Metadata,
	...
	listS2sPipelines(
		...
		callback: (error: grpc.ServiceError | null, response: ondewo_csi_conversation_pb.ListS2sPipelinesResponse) => void
	): grpc.ClientUnaryCall;
	listS2sPipelines(
		request: ondewo_csi_conversation_pb.ListS2sPipelinesRequest,
		metadata: grpc.Metadata,
	...
	s2sStream(): grpc.ClientDuplexStream<
		ondewo_csi_conversation_pb.S2sStreamRequest,
		ondewo_csi_conversation_pb.S2sStreamResponse
	>;
	s2sStream(
		options: Partial<grpc.CallOptions>
	): grpc.ClientDuplexStream<ondewo_csi_conversation_pb.S2sStreamRequest, ondewo_csi_conversation_pb.S2sStreamResponse>;
	s2sStream(
		metadata: grpc.Metadata,
		options?: Partial<grpc.CallOptions>
	): grpc.ClientDuplexStream<ondewo_csi_conversation_pb.S2sStreamRequest, ondewo_csi_conversation_pb.S2sStreamResponse>;
	checkUpstreamHealth(
		...
		callback: (
			...
			response: ondewo_csi_conversation_pb.CheckUpstreamHealthResponse
		) => void
	): grpc.ClientUnaryCall;
	checkUpstreamHealth(
		request: google_protobuf_empty_pb.Empty,
	...
	getControlStream(
		...
		options?: Partial<grpc.CallOptions>
	): grpc.ClientReadableStream<ondewo_csi_conversation_pb.ControlStreamResponse>;
	getControlStream(
		request: ondewo_csi_conversation_pb.ControlStreamRequest,
		metadata?: grpc.Metadata,
		options?: Partial<grpc.CallOptions>
	...
	setControlStatus(
		...
		callback: (error: grpc.ServiceError | null, response: ondewo_csi_conversation_pb.SetControlStatusResponse) => void
	): grpc.ClientUnaryCall;
	setControlStatus(
		request: ondewo_csi_conversation_pb.SetControlStatusRequest,
		metadata: grpc.Metadata,
